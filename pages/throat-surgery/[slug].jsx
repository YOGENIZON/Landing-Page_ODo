...
import { throatSurgery } from '../../src/data';
import CTA from 'components/CTA';

const surgeryArr = [
  '/tonsillectomy-surgery-hospital-location',
  '/thyroid-surgery-hospital-location',
  '/parotid-surgery-hospital-location',
  '/microlaryngeal-surgery-hospital-location',
  '/bronchoscopy-surgery-hospital-location',
  '/direct-laryngoscopy-biopsy-surgery-hospital-location'
];
...
export default ThroatSurgeries;
