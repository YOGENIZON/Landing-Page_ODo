...
import { earSurgery } from '../../src/data';
import CTA from 'components/CTA';

const surgeryArr = [
  '/tympanoplasty-surgery-hospital-location',
  '/mastoid-surgery-hospital-location',
  '/stapes-surgery-hospital-location',
  '/myringotomy-surgery-hospital-location'
];
const EarSurgeries = () => {
  ...
  const matchedSurgery = earSurgery.find((surgeries) => surgeries.url === slugToMatch);
  const canonicalUrl = `https://entrova.com/ear-surgery/${slug}`;
  const defaultSurgery = earSurgery[0];
                    ...
                    .map((item) => (
                      <div className="card shadow-lg" key={item.id}>
                        ...
                        <div className="card-body p-2">
                          <Link
                            href={currentPath.includes('/ear-surgery') ? `/ear-surgery/${item.url}` : item.url}
                            className="link"
                          >
