    ...
    <Fragment>
      ...
      <Head>
        ...
        <meta
          ...
          content=""
        />
        <link rel="canonical" href="https://entrova.com/privacy-policy" />
      </Head>
      <Breadcrumb className="d-flex flex-column align-items-center justify-content-center pt-14 pb-14 breadcrumbs">
        <div className="overlay"></div>
        <div className="text-center box">
          <h1 className="fs-56 fw-bold text-main">Privacy Policy</h1>
          <p className="mt-2 fs-18 text-white">
            <Link href="/" className='text-second'>Home</Link> / Privacy Policy
          </p>
        </div>
      </Breadcrumb>
      <main className="content-wrapper">
        <section>
          <div className="container mt-10 mb-8">
            <h2 className="fs-38">Privacy Policy</h2>
            <p className="fs-18">Last updated: May 30, 2025</p>
            <p className="fs-18">
            ...
            <h2 className="fs-38">Interpretation and Definitions</h2>
            <p className="fs-18">
              The words of which the initial letter is capitalized have meanings defined under the following conditions.
              The following definitions shall have the same meaning regardless of whether they appear in singular or in
              plural.
            </p>
            <h2 className="fs-38">Definitions</h2>
            <p className="fs-18">For the purposes of this Privacy Policy:</p>
            <ul>
              <li>
                <p className="fs-18">
              ...
              <li>
                <p className="fs-18">
                  <strong>Hospitals</strong> (referred to as either &quot;the Hospitals&quot;, &quot;We&quot;,
                  &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to ENTrova Bhuj, 210, Amrit Plaza, Skyline Avenue, Heritage Enclave, Bhuj, Mirjapur West, Gujarat 370001
                </p>
              </li>
              <li>
                <p className="fs-18">
              ...
              <li>
                <p className="fs-18">
                  <strong>Service Manufacturer</strong> means any natural or legal person who processes the data on
              ...
              <li>
                <p className="fs-18">
                  <strong>Website</strong> refers to ENTrova, accessible from
                  <Link href="https://entrova.com/" rel="external nofollow noopener" target="_blank">
                    https://entrova.com/
                  </Link>
                </p>
              </li>
            ...
            <h2 className="fs-38">Collecting and Using Your Personal Data</h2>
            <h3 className="fs-24">Personal Data</h3>
            <p className="fs-18">
            ...
            <ul>
              <li>
                <p className="fs-18">Email address</p>
              </li>
              <li>
                <p className="fs-18">First name and last name</p>
              </li>
              <li>
                <p className="fs-18">Phone number</p>
              </li>
              <li>
                <p className="fs-18">Usage Data</p>
              </li>
            </ul>
            <h3 className="fs-24">Usage Data</h3>
            <p className="fs-18">Usage Data is collected automatically when using the Service.</p>
            <p className="fs-18">
            ...
            <h3 className="fs-24">Tracking Technologies and Cookies</h3>
            <p className="fs-18">
            ...
            <p className="fs-18">We use both Session and Persistent Cookies for the purposes set out below:</p>
            <ul>
              <li>
                <p className="fs-18">
                  <strong>Necessary / Essential Cookies</strong>
                </p>
                <p className="fs-18">Type: Session Cookies</p>
                <p className="fs-18">Administered by: Us</p>
                <p className="fs-18">
              ...
              <li>
                ...
                <p className="fs-18">Type: Persistent Cookies</p>
                <p className="fs-18">Administered by: Us</p>
                <p className="fs-18">
            ...
            <h2 className="fs-38">Use of Your Personal Data</h2>
            <p className="fs-18">The Company may use Personal Data for the following purposes:</p>
            <ul>
              <li>
                <p className="fs-18">
            ...
            <p className="fs-18">We may share Your personal information in the following situations:</p>
            <ul>
              <li>
            ...
            <h2 className="fs-38">Retention of Your Personal Data</h2>
            <p className="fs-18">
            ...
            <h2 className="fs-38">Transfer of Your Personal Data</h2>
            <p className="fs-18">
            ...
            <h2 className="fs-38">Delete Your Personal Data</h2>
            <p className="fs-18">
            ...
            <h2 className="fs-38">Disclosure of Your Personal Data</h2>
            <h3 className="fs-24">Business Transactions</h3>
            <p className="fs-18">
            ...
            <h3 className="fs-24">Law enforcement</h3>
            <p className="fs-18">
            ...
            <h3 className="fs-24">Other legal requirements</h3>
            <p className="fs-18">
            ...
            <h2 className="fs-38">Security of Your Personal Data</h2>
            <p className="fs-18">
            ...
            <h2 className="fs-38">Children's Privacy</h2>
            <p className="fs-18">
            ...
            <h2 className="fs-38">Links to Other Websites</h2>
            <p className="fs-18">
            ...
            <h2 className="fs-38">Changes to this Privacy Policy</h2>
            <p className="fs-18">
            ...
            <h2 className="fs-38">Contact Us</h2>
            <p className="fs-18">If you have any questions about this Privacy Policy, You can contact us:</p>
            <ul>
              <li>
                <p className="fs-18">
                  By email: <Link href="mailto:contact@example.com">contact@example.com</Link>
                </p>
              </li>
              <li>
                <p className="fs-18">
