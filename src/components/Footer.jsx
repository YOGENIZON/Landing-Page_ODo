...
import { treatmentsFooter, aboutUsFooter } from '../data.js'; // common links section
    ...
    <footer className=" border-top bg-white-900 overflow-hidden">
      <div className="container pb-3 mt-10">
        <div className="row justify-content-around">
          ...
          <div className="col-sm-6 col-md-4 col-lg-2 mt-md-5 mt-lg-0 mt-10 ms-0 ms-md-5">{widget(aboutUsFooter, 'Quick Links')}</div>
          <div className="col-sm-6 col-md-4 col-lg-3  mt-md-5 mt-lg-0 mt-10 ms-0 ms-md-5">{widget(treatmentsFooter, 'Treatments')}</div>
